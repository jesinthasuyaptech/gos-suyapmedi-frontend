    ...
    fetchData();
      ...
      const fetchinstalldata = async () => {
          ...
          try {
            ...
            console.log("availabletime value:", firstItem?.category);
  ...
  <div><strong>Step 3:</strong> Click the <strong>Submit</strong> button to finalize the process.</div>
                 ...
                 <Modal
                  ...
                  footer={[
                    ...
                    onClick={() => {
                      setIsModalpop(false);
                      history.push('/admin/medicinebrandmaster'); // Call the switch case function here
                    }}
                  >
                    Continue
                  </Button>
