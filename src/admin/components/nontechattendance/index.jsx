...
const NonTechAttendance = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await fetch(
        `${var_api}nontechnicalstaff/getby-hospital/${hospital_id}`,
        {
          headers: {
    ...
    try {
      const response = await fetch(
        `${var_api}nontechstaffattendance/getdetails/${hospital_id}/${selectedDate}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: token,
  ...
  const fetchbreaks = async (id) => {
    ...
    try {
      const response = await fetch(
        `${var_api}nontechstaffbreak/get-attendance/${id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: token,
  ...
  const handleAttendance = async (id) => {
    ...
    try {
      ...
      const response = await fetch(`${var_api}nontechstaffattendance/post`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: token,
  ...
  const handleLogout = async (id,login_time) => {
    ...
    try {
      ...
      const response = await fetch(`${var_api}nontechstaffattendance/update-logout/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: token,
  ...
  const handleBreakSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`${var_api}nontechstaffbreak/post`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: token,
  ...
  const handleBreakStop = async (id,break_start) => {
    ...
    try {
      ...
      const response = await fetch(
        `${var_api}nontechstaffbreak/update-breakstop/${id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      const responsebreak = await fetch(
        `${var_api}nontechstaffattendance/update-break/${selectedAttId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const breakscol = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          {!record.break_end && ( // Only show button if break_end does not exist
            <Button
      ...
      <div className="page-wrapper">
        <div className="content container-fluid">
          <div className="page-header">
            <div className="row">
              <div className="col">
                <h3 className="page-title">Non Technicalstaff Tables</h3>
                <ul className="breadcrumb">
                  <li className="breadcrumb-item">
                    <Link to="/admin">Dashboard</Link>
                  </li>
                  <li className="breadcrumb-item active">
                    Non Technicalstaff Tables
                  </li>
                </ul>
              </div>
            ...
            <div className="col-sm-12">
              <div className="card">
                <div className="card-header">
                  <h4 className="card-title">Non Technicalstaff</h4>
                </div>
...
export default NonTechAttendance;
