...
const medicineuom = () => {
  ...
  setLoading(true);
      ...
      if (!editData && (response.status === 200 || response.status === 201)) {
        ...
        updateTechstaffStatus(); // <-- Make sure this function is defined
      }
    setLoading(false);
...
const fetchinstalldata = async () => {
  ...
  try {
    ...
    // Access the first item in the array and log the uom value
    const firstItem = result[0];
    if (firstItem) {
      setInstallDetails(firstItem); // Save the full object
    }
    console.log("uom value:", firstItem?.uom);
    ...
    // Log for debugging modal condition
    if (firstItem?.uom === 0) {
      console.log("Modal should show: uom is 0");
      setIsModalInsta(true);
    } else {
      console.log("Modal not triggered: uom is not 0");
    ...
    },
    {
      ...
      render: (_, record) => (
        ...
        <a
          ...
          onClick={() => handleDeleteConfirm(record.id, record.uom_name)}
        >
      ...
      {loading && (
        ...
        <div className="content container-fluid">
          <div className="page-header">
            <div className="row">
              <div className="col">
                <h3 className="page-title">MedicineUom Tables</h3>
                <ul className="breadcrumb">
                  <li className="breadcrumb-item">
                    <Link to="/admin">Dashboard</Link>
                  </li>
                  <li className="breadcrumb-item active">MedicineUom Tables</li>
                </ul>
              </div>
            ...
            <div className="col-sm-12">
              <div className="card">
                <div className="card-header">
                  <h4 className="card-title">Medicine Uom</h4>
                </div>
...
>
  <p>Are you sure you want to delete this Medicineuom "<span style={{fontWeight:"bold"}}>{deletename}</span>"?</p>
  <Form.Item>
    <div className="d-flex justify-content-center">
      <button
        type="button"
  ...
  <div><strong>Step 3:</strong> Click the <strong>Submit</strong> button to finalize the process.</div>
           ...
           <Modal
            ...
            footer={[
              ...
              onClick={() => {
                setIsModalpop(false);
                history.push('/admin/medicineCategory'); // Call the switch case function here
              }}
            >
              Continue
            </Button>
