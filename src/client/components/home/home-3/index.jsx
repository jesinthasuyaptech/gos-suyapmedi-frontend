...
const Home3 = () => {
 ...
 <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", marginLeft: "40px", marginTop: "30px" }}>
...
{/* <button
  ...
  style={{
    ...
    padding: "10px 20px",
    border: "none",
    borderRadius: "25px",  // Updated for a more rounded shape
    cursor: "pointer",
    fontSize: "16px",
    display: "flex",
    alignItems: "center",
...
>
  <i className="fa fa-user-plus" style={{ fontSize: "18px" }}></i>
...
>
  <i className="fa fa-sign-in" style={{ fontSize: "18px" }}></i>
   Login
</button>
  ...
  <h2 style={{ marginTop: "20px" }}>
      <h2 style={{ margin: 0, color: "#007bff", fontWeight: "bold", fontSize: "32px" }}>
    SuyapMedi,
  </h2>
    Make an Appointment
    <br />
