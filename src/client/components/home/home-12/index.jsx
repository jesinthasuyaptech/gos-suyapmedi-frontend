  ...
  const data = [
    {
      ...
      description:
        "After struggling with chronic sinus problems, I found relief at SuyapDoc. The ENT specialists here are not only highly skilled but also genuinely caring. They took the time to understand my concerns, provided a detailed diagnosis, and guided me through a treatment plan that has greatly improved my quality of life.",
    },
    {
      image: client_02,
      name: "Madeleine Jennifer",
              ...
              <div className="col-lg-6 d-flex">
                <div className="servive-provider-content">
                  ...
                  >
                    ...
                    <p>
                      One of the most popular services SuyapDoc offers is
                  ...
                  <div className="lab-service-features">
                    <ul>
                      <li data-aos="fade-down" data-aos-delay={400}>
                        ...
                        <h6>The SuyapDoc - Easy Way To Book Lab Tests Online</h6>
                      </li>
