            ...
            <div className="col-lg-6">
              <div className="banner-content aos" data-aos="fade-up">
                ...
                <ImageWithBasePath
                  ...
                  alt="header-icon"
                />
                <p>Embark on your healing journey with SuyapDoc</p>
                  ...
                  <div className="doc-content">
                    <div className="doc-pro-info">
                      <div className="doc-pro-name">
                        <Link to="/patient/doctor-profile">Dr. Sundhar</Link>
                        <p>Orthopedic</p>
                      </div>
              ...
              <div className="item">
                <div className="doctor-profile-widget doc-item">
                  ...
                  <div className="doc-content">
                    <div className="doc-pro-info">
                      <div className="doc-pro-name">
                        <Link to="/patient/doctor-profile">Dr. Kumarasan</Link>
                        <p>Dentist</p>
                      </div>
                      <div className="reviews-ratings">
                        <p>
              ...
              <div className="item">
                <div className="doctor-profile-widget doc-item">
                  ...
                  <div className="doc-content">
                    <div className="doc-pro-info">
                      <div className="doc-pro-name">
                        <Link to="/patient/doctor-profile">Dr. karthik</Link>
                        <p>Neurology</p>
                      </div>
                      <div className="reviews-ratings">
                        <p>
              ...
              <div className="item">
                <div className="doctor-profile-widget doc-item">
                  ...
                  <div className="doc-content">
                    <div className="doc-pro-info">
                      <div className="doc-pro-name">
                        <Link to="/patient/doctor-profile">Dr. Kathiresan</Link>
                        <p>Immunologist</p>
                      </div>
                      <div className="reviews-ratings">
                        <p>
              ...
              <div className="item">
                <div className="doctor-profile-widget doc-item">
                  ...
                  <div className="doc-content">
                    <div className="doc-pro-info">
                      <div className="doc-pro-name">
                        <Link to="/patient/doctor-profile">Dr. Manikandan</Link>
                        <p>Dentist</p>
                      </div>
                      <div className="reviews-ratings">
                        <p>
                  ...
                  <div className="articles-right">
                    <div className="articles-content">
                      <ul className="articles-list nav">
                        <li>
                          <i className="feather icon-user" /> Kumarasan
                        </li>
                        <li>
              ...
              <div className="col-lg-6 col-md-12">
                <div className="app-content">
                  <div className="app-header aos" data-aos="fade-up">
                    ...
                    <h2>Download the SuyapDoc App today!</h2>
                  </div>
                    ...
                    <div className="testimonial-info">
                      ...
                      <div className="testimonial-content">
                        ...
                        <div className="testimonial-details">
                          <p>
                            SuyapDoc exceeded my expectations in healthcare. The
                            ...
                            truly sets them apart. I highly recommend SuyapDoc
                            for anyone seeking reliable and accessible
                            healthcare services.
                          </p>
                          <h6>
                            <span className="d-block">Kumarasan</span> New York
                          </h6>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="testimonial-content">
                        ...
                        <div className="testimonial-details">
                          <p>
                            ...
                            appointments. Thanks to SuyapDoc, booking
                      ...
                      <div className="testimonial-content">
                        ...
                        <div className="testimonial-details">
                          <p>
                            ...
                            family can be overwhelming. SuyapDoc has simplified
                            ...
                            appointment. I highly recommend SuyapDoc to other
                            busy parents!
                          </p>
                          <h6>
