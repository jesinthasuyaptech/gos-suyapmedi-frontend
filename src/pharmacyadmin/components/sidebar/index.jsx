...
<div id="sidebar-menu" className="sidebar-menu">
            <ul>
              ...
              <li className="submenu">
                ...
                >
                  <i className="fe fe-document"></i> <span> Masters</span>{" "}
                ...
                {isSideMenu == "Products" ? (
                  ...
                  >
                    <li>
                      <Link
                        className={
                          pathname && pathname.includes("medicinebrandmaster")
                            ? "active"
                            : ""
                        }
                        to="/pharmacyadmin/medicinebrandmaster"
                      >
                        Brand
                      </Link>
                    </li>
                    <li>
                      <Link
                        className={
                          pathname && pathname.includes("medicinecategory")
                            ? "active"
                            : ""
                        }
                        to="/pharmacyadmin/medicinecategory"
                      >
                        Category
                      </Link>
                    </li>
                    <li>
                      <Link
                        className={
                          pathname && pathname.includes("medicinesubcategory")
                            ? "active"
                            : ""
                        }
                        to="/pharmacyadmin/medicinesubcategory"
                      >
                        Sub-Category
                      </Link>
                    </li>
                    <li>
                      <Link
                        className={
                          pathname && pathname.includes("paymodemaster")
                            ? "active"
                            : ""
                        }
                        to="/pharmacyadmin/paymodemaster"
                      >
                        Paymode Master
                      </Link>
                    </li>
                    <li>
                      <Link
                        className={
                          pathname && pathname.includes("taxmaster")
                            ? "active"
                            : ""
                        }
                        to="/pharmacyadmin/taxmaster"
                      >
                        Tax Master
                      </Link>
                    </li>
              ...
              >
                <Link to="/pharmacyadmin/medicalbilling">
                  <i className="fe fe-layout" /> <span>Medicien Billing</span>
                </Link>
              </li>
              {/* <li className="submenu">
                <Link
              ...
              >
                <Link to="/pharmacyadmin/report">
                  <i className="fe fe-activity" /> <span>Report</span>
                </Link>
              </li>
              {/* <li className="submenu">
                <Link
                ...
                >
                  <i className="fe fe-user"></i> <span>Report</span>{" "}
                  <span className="menu-arrow"></span>
                </Link>
                <ul
                  style={{
              ...
              <li className="submenu">
                ...
                >
                  ...
                  {/* <li>
                    <Link
                      className={
                        pathname && pathname.includes("paymode")
                          ? "active"
                          : ""
                      }
                      to="/pharmacyadmin/paymodereport"
                    >
                      Paymode Reports
                    </Link>
                  </li> */}
